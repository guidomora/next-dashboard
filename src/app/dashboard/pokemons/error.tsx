        ...
        <div className="w-full h-screen flex flex-col items-center justify-center">
            ...
            >
                ...
                <path
                    ...
                    opacity="0.8"
                ></path>
                <path fill="currentColor" d="M317.609 150H333.609V166H317.609z"></path>
                <path
                    fill="currentColor"
                ...
                <path
                    ...
                    opacity="0.8"
                ></path>
                <path fill="currentColor" d="M317.609 251H333.609V267H317.609z"></path>
                <path
                    fill="currentColor"
                ...
                <path
                    ...
                    opacity="0.8"
                ></path>
                <path fill="currentColor" d="M317.609 352H333.609V368H317.609z"></path>
