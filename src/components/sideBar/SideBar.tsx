...
const menuItems = [
    {path:'/dashboard/main', icon:<IoBrowsersOutline size={40}/>, title:'Dashboard', subTitle:'Visualizacion'},
    ...
    {path:'/dashboard/favourites', icon:<IoHeartOutline size={40}/>, title:'Favourites', subTitle:'Global state'}
]
